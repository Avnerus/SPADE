...
parser.add_argument('--annotation_file', type=str, default="./annotations/instances_val2017.json",
...
parser.add_argument('--input_label_dir', type=str, default="./val_label/",
...
parser.add_argument('--output_instance_dir', type=str, default="./val_inst/",
